fsutil hardlink create Action3.cfg ..\English\Action3.cfg
fsutil hardlink create Action4.cfg ..\English\Action4.cfg
fsutil hardlink create Action5.cfg ..\English\Action5.cfg
fsutil hardlink create Actions.cfg ..\English\Actions.cfg
fsutil hardlink create Bar.cfg ..\English\Bar.cfg
...
fsutil hardlink create Dumps.cfg ..\English\Dumps.cfg
...
fsutil hardlink create Requests.cfg ..\English\Requests.cfg
fsutil hardlink create Shops.cfg ..\English\Shops.cfg
...
fsutil hardlink create Tiedowns.cfg ..\English\Tiedowns.cfg
fsutil hardlink create Trucks2.cfg ..\English\Trucks2.cfg
fsutil hardlink create Trucks3.cfg ..\English\Trucks3.cfg
fsutil hardlink create Trucks4.cfg ..\English\Trucks4.cfg
fsutil hardlink create Unbar.cfg ..\English\Unbar.cfg
