...
CP(Goic/common/extraHole.cfg OPT,CFGDEVICE/extraHole.cfg)
...
CP(Goic/common/Pattern.cfg OPT,CFGDEVICE/Pattern.cfg)
CP(Goic/common/DelPattern.cfg OPT,CFGDEVICE/DelPattern.cfg)
CP(Goic/drill/LANGUAGE/wKp.cfg OPT,CFGDEVICE/wKp.cfg)
CP(Goic/drill/LANGUAGE/wKp2.cfg OPT,CFGDEVICE/wKp2.cfg)
CP(Goic/drill/LANGUAGE/Pattern.cfg OPT,CFGDEVICE/Pattern.cfg)
CP(Goic/drill/LANGUAGE/Matl.cfg OPT,CFGDEVICE/Matl.cfg)
CP(Goic/drill/LANGUAGE/Dismount.cfg OPT,CFGDEVICE/Dismount.cfg)

CP(Goic/drill/LANGUAGE/w0.ht.cfg OPT,CFGDEVICE/w0.ht.cfg)
CP(Goic/drill/LANGUAGE/WinMgr.cfg OPT,CFGDEVICE/WinMgr.cfg)
CP(Goic/drill/LANGUAGE/Actions.cfg OPT,CFGDEVICE/Actions.cfg)
CP(Goic/drill/LANGUAGE/Info.cfg OPT,CFGDEVICE/Info.cfg)
CP(Goic/LANGUAGE/Goic.cfg OPT,CFGDEVICE/Goic.cfg)
CP(Goic/drill/LANGUAGE/Ok.cfg OPT,CFGDEVICE/Ok.cfg)
...
#ifndef NOHP
CP(Goic/drill/LANGUAGE/Macro.cfg  _LANGUAGE_=LANGUAGE OPT,CFGDEVICE/Macro.cfg)
CP(Goic/common/wScreen.cfg OPT,CFGDEVICE/wScreen.cfg)
CP(Goic/drill/LANGUAGE/wDrilling.cfg OPT,CFGDEVICE/wDrilling.cfg)
CP(Goic/CLASS/LANGUAGE/wGpsstat.cfg OPT,CFGDEVICE/wGpsstat.cfg)
CP(Goic/drill/English/wInfo.cfg OPT,CFGDEVICE/wInfo.cfg)
CP(Goic/drill/LANGUAGE/w0.cfg OPT,CFGDEVICE/w0.cfg)
#else
CP(Goic/drill/LANGUAGE/Macro_low.cfg  _LANGUAGE_=LANGUAGE OPT,CFGDEVICE/Macro.cfg)
CP(Goic/common/wScreen_low.cfg OPT,CFGDEVICE/wScreen.cfg)
CP(Goic/drill/English/wDrilling_low.cfg OPT,CFGDEVICE/wDrilling.cfg)
CP(Goic/drill/English/w0_low.cfg OPT,CFGDEVICE/w0.cfg)
CP(Goic/drill/English/wInfo_low.cfg OPT,CFGDEVICE/wInfo.cfg)
#endif
