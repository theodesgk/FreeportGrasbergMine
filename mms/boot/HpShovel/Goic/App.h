 ...
 *    $State: Exp $
 *   Purpose: Load script for GpsHpExcav module
 * * * * * * * * * * * * * * * * * * *
 */
#ifndef ISOPTION
   echo GpsHpExcav can only be an option
#else
  ...
  LD(HpGpsShovelUtilities,APPDEVICE/HpGpsShovelUtilities)
  LD(HpGpsCoordinator,APPDEVICE/HpGpsCoordinator)
  LD(HpGpsShovelCoordinator,APPDEVICE/HpGpsShovelCoordinator)
