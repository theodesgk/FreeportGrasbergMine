...
CP(icons/SCREEN/CLASS/loading.icon,ICONDEVICE/tramloading.icon)
CP(icons/SCREEN/CLASS/full.icon,ICONDEVICE/full.icon)
CP(icons/SCREEN/CLASS/dumping.icon,ICONDEVICE/dumping.icon)
CP(icons/SCREEN/CLASS/ldtruck.icon,ICONDEVICE/loading.icon)
