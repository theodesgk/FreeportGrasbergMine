...
#ifdef NEWUI
/* any file paths that are hard coded with English use dictionary entries so that we
...
CP(Goic/LANGUAGE/ManAsn.cfg OPT,                CFGDEVICE/ManAsn.cfg)
CP(Goic/LANGUAGE/Locs.cfg OPT,                  CFGDEVICE/Locs.cfg)
CP(Goic/LANGUAGE/Shovels.cfg OPT,               CFGDEVICE/Shovels.cfg)
#if #arch(pe)
CP(Goic/LANGUAGE/Shovels.cfg OPT,               CFGDEVICE/Shovels2.cfg)
CP(Goic/LANGUAGE/Shovels.cfg OPT,               CFGDEVICE/Shovels3.cfg)
#else
