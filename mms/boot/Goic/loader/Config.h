...
CP(Goic/common/wSplits.cfg OPT,CFGDEVICE/wSplits.cfg)
...
CP(Goic/common/wProject.cfg OPT,CFGDEVICE/wProject.cfg)
...
CP(Goic/CLASS/LANGUAGE/wInfo.cfg OPT,CFGDEVICE/wInfo.cfg)
/*CP(Goic/CLASS/LANGUAGE/w0.Clock.cfg OPT,CFGDEVICE/w0.Clock.cfg)*/
CP(Goic/CLASS/LANGUAGE/w0.ht.cfg OPT UNT,CFGDEVICE/w0.ht.cfg)
...
CP(Goic/CLASS/LANGUAGE/Material.cfg OPT,CFGDEVICE/Material.cfg)
CP(Goic/CLASS/LANGUAGE/Material2.cfg OPT,CFGDEVICE/Material2.cfg)
#if #arch(pe)
CP(Goic/CLASS/LANGUAGE/Material2.cfg OPT,CFGDEVICE/Material3.cfg)
CP(Goic/CLASS/LANGUAGE/Material2.cfg OPT,CFGDEVICE/Material4.cfg)
#else
